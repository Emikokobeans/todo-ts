...
(0, ava_1.default)('identical', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const diagnostics = yield (0, __1.default)({ cwd: path_1.default.join(__dirname, 'fixtures/identicality/identical') });
...
(0, ava_1.default)('not identical', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const diagnostics = yield (0, __1.default)({ cwd: path_1.default.join(__dirname, 'fixtures/identicality/not-identical') });
    (0, utils_1.verify)(t, diagnostics, [
