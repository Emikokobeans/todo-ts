...
(0, ava_1.default)('deprecated', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const diagnostics = yield (0, __1.default)({ cwd: path_1.default.join(__dirname, 'fixtures/deprecated/expect-deprecated') });
...
(0, ava_1.default)('not deprecated', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const diagnostics = yield (0, __1.default)({ cwd: path_1.default.join(__dirname, 'fixtures/deprecated/expect-not-deprecated') });
    (0, utils_1.verify)(t, diagnostics, [
